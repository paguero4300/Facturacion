...
return [
    ...
    'company' => [
        'ruc' => env('GREENTER_COMPANY_RUC', '20605878840'),
        'razonSocial' => env('GREENTER_COMPANY_NAME', 'CORPORACION BLYMS OROL S.A.C.'),
        'nombreComercial' => env('GREENTER_COMPANY_COMMERCIAL_NAME', 'BLYMS OROL'),
