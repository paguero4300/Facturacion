...
<section class="relative overflow-hidden">
    ...
    <div class="absolute top-20 left-10 w-20 h-20 rounded-full opacity-20 animate-bounce" style="background-color: var(--naranja);"></div>
    ...
    <div
        class="absolute top-40 right-20 w-0 h-0 border-l-[30px] border-l-transparent border-b-[50px] border-r-[30px] border-r-transparent opacity-30 transform rotate-45"
        style="border-bottom-color: var(--naranja);">
    </div>
    <div
        class="absolute bottom-40 left-20 w-0 h-0 border-l-[25px] border-l-transparent border-b-[40px] border-r-[25px] border-r-transparent opacity-30 transform -rotate-45"
        ...
        <div class="grid md:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
            ...
            <div class="order-2 md:order-1 space-y-8">
                <div class="space-y-4">
                    <!-- Badge con animación -->
                    <div
                        class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold tracking-wide animate-pulse"
                    ...
                    <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                        <span class="bg-clip-text text-transparent" style="background-image: linear-gradient(to right, var(--naranja), var(--azul-claro));">
                            Detalles
                        </span>
                        <br>
                ...
                <div
                    class="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border transform hover:scale-105 transition duration-300"
                    style="border-color: var(--naranja);">
                    <div class="flex flex-col md:flex-row items-center gap-6">
                        <!-- Imagen de contacto -->
                        <div class="relative">
                            <div class="w-40 h-40 rounded-full overflow-hidden border-4 shadow-lg transform hover:scale-105 transition duration-300" style="border-color: var(--naranja);">
                                <img src="{{ asset('logos/herocontac1.jpg') }}" alt="Imagen de contacto" class="w-full h-full object-cover">
                            </div>
                            <!-- Efecto de brillo en la imagen -->
                            <div class="absolute inset-0 rounded-full opacity-0 hover:opacity-30 transition duration-300" style="background: radial-gradient(circle, rgba(255,255,255,0.8) 0%, rgba(255,153,0,0.4) 100%);"></div>
                        </div>
                        <!-- Información de contacto -->
                        <div class="text-center md:text-left flex-1">
                            <p class="font-bold text-xl flex items-center justify-center md:justify-start gap-3" style="color: var(--naranja);">
                                <span class="text-3xl p-3 rounded-full animate-pulse" style="background-color: rgba(255, 153, 0, 0.1);">🌻</span>
                                <a href="tel:+51944492316" class="hover:underline transition duration-300" style="color: var(--naranja);">(51) 944 492 316</a>
                            </p>
                            <p class="text-base mt-3 font-medium" style="color: var(--texto-principal);">Llámanos para hacer tu pedido</p>
                            <div class="mt-3 flex justify-center md:justify-start">
                                <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold" style="background-color: rgba(255, 153, 0, 0.1); color: var(--naranja);">Disponible 24/7</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="rounded-xl p-6 border-l-4 shadow-sm"
            ...
            <div class="order-1 md:order-2">
                <div class="relative">
                    ...
                    <div
                        class="absolute -inset-6 rounded-3xl opacity-30 blur-xl animate-pulse"
                    ...
                    <div
                        ...
                        <div class="absolute -top-4 -left-4 w-8 h-8 rounded-full opacity-70" style="background-color: var(--naranja);"></div>
                        <div class="absolute -bottom-4 -right-4 w-6 h-6 rounded-full opacity-70" style="background-color: var(--azul-claro);"></div>
                    </div>
                </div>
            </div>
        </div>
